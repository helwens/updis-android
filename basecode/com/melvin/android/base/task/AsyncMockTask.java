...
public abstract class AsyncMockTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            final int increment = mCount.getAndIncrement();
            return new Thread(r, "AsyncMockTask #" + increment);
        }
    };
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new AsyncTaskResult<Result>(AsyncMockTask.this,
                                    (Result[]) null));
    ...
    public final AsyncMockTask<Params, Progress, Result> execute(
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        ...
        @SuppressWarnings("rawtypes")
        AsyncTaskResult(AsyncMockTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
