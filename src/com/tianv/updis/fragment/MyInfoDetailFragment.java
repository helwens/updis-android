...
public class MyInfoDetailFragment extends BaseFragment implements OnClickListener,
        DialogInterface.OnClickListener, OnItemClickListener {

    private Map<String, String> hashMap = null;

    public MyInfoDetailFragment(Activity activity, String moduleCode) {
    ...
    public View setBodyView(Context context, LayoutInflater inflater, int index) {
        View view = inflater.inflate(R.layout.person_detail_layout, null);
