 ...
 * @author Melvin
 * @version V1.0
 * @ClassName: TalkFragment.java
 * @Description: TODO
 * @Date 2013-4-10 上午10:09:24
 */
public class TalkFragment extends BaseFragment implements OnItemClickListener {
    ...
    public TalkFragment(Activity activity, String moduleCode) {
