...
public final class AndroidHttpClient implements HttpClient {
     ...
     */
    public static AndroidHttpClient newInstance(Context context) {
        HttpParams params = UUHttpClient.createHttpParams(context);
        ClientConnectionManager manager = UUHttpClient.createClientConnectionManager(params);
        AndroidHttpClient httpClient = new AndroidHttpClient(manager, params);
        return httpClient;
    }
