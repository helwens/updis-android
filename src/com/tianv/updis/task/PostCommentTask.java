 ...
 */
public class PostCommentTask extends BaseTask<Void, Void, String> {
    ...
    public PostCommentTask(Context context, TaskCallBack<Void, String> taskCallBack,
    ...
    public String doInBackground(Void... params) {
        ...
        try {
            return CollectResource.getInstance(context).postComment(paramsMap);
