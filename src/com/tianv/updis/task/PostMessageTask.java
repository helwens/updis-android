 ...
 */
public class PostMessageTask extends BaseTask<Void, Void, String> {
    ...
    public PostMessageTask(Context context, TaskCallBack<Void, String> taskCallBack,
    ...
    public String doInBackground(Void... params) {
        ...
        try {
            return CollectResource.getInstance(context).postMessage(paramsMap);
